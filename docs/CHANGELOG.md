...
## v3.23.1
* 배너·네이티브 광고 노출 콜백 추가
* 비즈보드 광고 기본 노출 비율 320:100 전환
* 오픈소스 고지문 업데이트
* 버그 픽스 및 개선

## v3.22.2
* 광고 서버 도메인 변경
* 하단형 팝업 광고 노출 미측정 오류 수정
* 버그 픽스 및 개선

## v3.21.17
* 앱 종료 광고 Android 16 대응
* 버그 픽스 및 개선

## v3.21.16
* 팝업형 광고 딤드 영역 클릭 시, 닫힘 처리 추가
* 팝업형 광고 WindowLeaked 오류 수정
* 버그 픽스 및 개선

## v3.21.13
* 여러 개의 네이티브 광고 요청 API 추가
* 팝업 광고 API 뒤로가기 이벤트 추가
* 팝업 광고 API 네비게이션 바 색상 지정 기능 추가
* 팝업 광고 관련 API 버그 픽스
* 버그 픽스 및 개선
